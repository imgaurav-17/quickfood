...
function Resturantcard({ resData }) {
    const { name, avgRating, cloudinaryImageId, cuisines, locality } = resData?.info;
    return (
        <div className='flex flex-col gap-4 p-4 w-56 hover:ease-in-out transform hover:scale-95 transition duration-300 ease-in'>
            <img src={imgURL + cloudinaryImageId} alt="logo" className='w-48 rounded-xl object-cover object-center h-32 ' />
            <div>
